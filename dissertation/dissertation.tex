...
\label{fabricLedger}
	...
	The world state is a database that holds the \textbf{current values} of the assets in the ledger as ledger states. The ledger states are usually expressed as key-value pairs, though there is some flexability in this regard. The world state changes frequently because of the CRUD operations applied on the network. 
