...
\begin{description}
  ...
  This project was undertaken to research blockchain - more specifically one such for business use cases. This new technology is capable of securing information, while also certify for its integrity inside the network. 
	Because of the security and integrity of this technology provides. A certain research about identity has started going around. The idea for what exactly is person’s identity and can it be made more explicit and secure. 
	The scope of this project was to research the blockchain framework Hyperledger Fabric and an attempt of self-sovereign identity prototype. 
	The field of blockchain is still in its infancy and is developing with a rapid growth. At the start of this project, Fabric was version 1.2 and the project kept its development consistent with it. However at the time of handing in, Fabric is already at version 1.4. 
	The business logic for a Fabric blockchain app, at the time of writing can be done in two ways. The first is by using only Fabric and write low-level golang (recommended) code or use Hyperledger Composer, to develop and install the system on top of the Fabric nodes. 
...
Recently a new technology emerged into the world that is called blockchain. The idea is that it is a distributed decentralized database of blocks of transactions. The reason why it is very interesting is that it has the potential to change many aspects of life, by changing the way of accessibility and security of a data. Hyperledger Fabric is a blockchain framework designed especially to make the system easily adoptable for different business use cases. The main two objectives of this project are: to research how the smart contracts in Hyperledger Fabric works; to make a prototype of self-sovereign system with the gathered knowledge. 
