 ...
 */
 ...
 const namespace = "org.ring";
 const transactionType = "passTheToken";
...
function main(error){
    ...
    let transaction = factory.newTransaction(namespace,transactionType,tokenKey,options);

    transaction.setPropertyValue('ta','resource:org.ring.TraderA#TA');
    transaction.setPropertyValue('tb', 'TB');
    transaction.setPropertyValue('token' , 'token');
