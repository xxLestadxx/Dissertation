...
const routes: Routes = [
  ...
  { path: 'DrivingLicence', component: DrivingLicenceComponent },
  { path: 'UniversityDiploma', component: UniversityDiplomaComponent },
  { path: 'Person', component: PersonComponent },
  { path: 'HighSchool', component: HighSchoolComponent },
  { path: 'DrivingSchool', component: DrivingSchoolComponent },
  { path: 'University', component: UniversityComponent },
  { path: 'createDiploma', component: createDiplomaComponent },
  { path: 'createDrivingLicence', component: createDrivingLicenceComponent },
  { path: 'enrollInUniversity', component: enrollInUniversityComponent },
  { path: 'graduateUni', component: graduateUniComponent },
  { path: 'queryDiplomas', component: queryDiplomasComponent },
  { path: '**', redirectTo: '' }
];
